...
solidfire_cluster_volume_async_result_count{completed="false",status="Clone",success="true"} 2
solidfire_cluster_volume_async_result_count{completed="true",status="Clone",success="false"} 1
solidfire_cluster_volume_async_result_count{completed="true",status="Clone",success="true"} 2
solidfire_cluster_volume_async_result_count{completed="true",status="NotClone",success="true"} 1
